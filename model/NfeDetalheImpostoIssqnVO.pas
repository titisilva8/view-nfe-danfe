...
type
  ...
  private
    ...
    FPAIS_SERVICO_PRESTACAO: Integer;
  ...
  public
    ...
    [TColumn('PAIS_SERVICO_PRESTACAO', 'Pais Servico Prestado', 80, [ldGrid, ldLookup, ldCombobox], False)]
    [TFormatter(ftZerosAEsquerda, taCenter)]
    property PaisServicoPrestacao: Integer  read FPAIS_SERVICO_PRESTACAO write FPAIS_SERVICO_PRESTACAO;
