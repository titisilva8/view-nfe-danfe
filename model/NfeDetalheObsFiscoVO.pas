...
type
  [TEntity]
  [TTable('NFE_DETALHE_OBS_FISCO')]
  TNfeDetalheObsFiscoVO = class(TVO)
  private
    FID: Integer;
...
initialization
  Classes.RegisterClass(TNfeDetalheObsFiscoVO);

finalization
  Classes.UnRegisterClass(TNfeDetalheObsFiscoVO);
